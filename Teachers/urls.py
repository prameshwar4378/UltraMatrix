...
urlpatterns = [
    ...
    path("teachers/quick-create/", views.teacher_quick_create, name="teacher_quick_create"),
    path("teachers/<int:pk>/update/", views.teacher_update, name="teacher_update"),
    path("teachers/<int:pk>/delete/", views.teacher_delete, name="teacher_delete"),
    path("teachers/bulk-delete/", views.teacher_bulk_delete, name="teacher_bulk_delete"),
