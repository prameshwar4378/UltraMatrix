...
urlpatterns = [
    ...
    path("class-sections/quick-create/", views.class_sections_quick_create, name="class_sections_quick_create"),
    ...
    path("class-level/bulk-delete/", views.class_level_bulk_delete, name="class_level_bulk_delete"),
    ...
    path("class-section/bulk-delete/", views.class_section_bulk_delete, name="class_section_bulk_delete"),
]
